...
<h3 class="my-3 text-center text-uppercase">DANH SÁCH NHIỆM VỤ CỦA <?= $name_employee ?></h3>
        ...
        foreach ($output as $value) {
            ...
            echo '
                    <tr>
                        ...
                        <a href="?type=task_employee&action=detail&id_task=' . $value['id_task'] . '" class="btn btn-sm btn-success">
                            Xem chi tiết
                        </a></td>
                    </tr>
                ';
