        ...
        <div class="card card-5 p-5">
            <form id="add-task" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group text-right">
                    <button data-target="#confirm-add-task" id="add-task-btn" type="button" class="btn btn-dark">Submit</button>
                </div>

                <div class="modal fade" id="confirm-add-task">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Bạn có chắc chắn rằng muốn <?=isset($_GET['id_task']) ? 'chỉnh sửa' : 'thêm'?> nhiệm vụ này không?
                            </div>

                            <div class="modal-footer">
                                <button name="btn-submit" type="submit" id="add-task-confirm-btn" class="btn btn-danger">Đồng ý</button>
